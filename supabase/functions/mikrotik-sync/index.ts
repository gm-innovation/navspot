...
// v7.1.44: Clean file write fix for RouterOS 7.x header injection
const VERSION = "7.1.44"

// v7.1.44: Required portal profile version - forces reconfigure when changed
const REQUIRED_PORTAL_VERSION = "7.1.44-http-pap"
