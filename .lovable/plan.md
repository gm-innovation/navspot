...
## Fix aplicado: pré-resolver `find` e pré-construir URL em variáveis locais

Linha 86 substituída por 3 linhas curtas:
...
1. **SQL UPDATE `script_templates` (id='infra')** — substituída linha 86 por 3 linhas com variáveis locais
2. **`.lovable/plan.md`** — documentado fix
